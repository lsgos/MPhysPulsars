...
SUPPORTED_ALGORITHMS = ["jmi","mi","hel"]
S_ALGS_LONG = ["Joint Mutual Information", "Mutual Information", "Hellinger Distance"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("filename",help="The file containing the dataset. Must be in space seperated variable format with discretised data")
    ...
    parser.add_argument("-a", "--algorithm", help = "Which feature selection algorithm to evaluate: options: [jmi,mi,hel]", default = "mi")

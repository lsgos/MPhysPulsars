...
class ClassifierStats:
    ...
    def calculate(self):
        ...
        self.precision = 0.0 if self.TP == 0.0 else (self.TP) / (self.TP + self.FP)

        self.recall = 0.0 if self.TP == 0.0 else (self.TP) / (self.TP + self.FN)

        self.specificity = 0.0 if self.TN == 0.0 else (self.TN) / (self.FP+self.TN)

        self.negativePredictiveValue = 0.0 if self.TN == 0.0 else (self.TN) / (self.FN + self.TN)

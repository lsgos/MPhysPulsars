...
#define __PYX_HAVE__hellinger_tree
#define __PYX_HAVE_API__hellinger_tree
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'hellinger_tree' */
...
static double __pyx_f_14hellinger_tree_calcHellingerDistance(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_14hellinger_tree_get_best_feature(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "hellinger_tree"
int __pyx_module_is_main_hellinger_tree = 0;

/* Implementation of 'hellinger_tree' */
...
static const char __pyx_k_This_function_only_works_on_two[] = "This function only works on two class problems";
static const char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static const char __pyx_k_Buffer_view_does_not_expose_stri[] = "Buffer view does not expose strides";
static const char __pyx_k_Can_only_create_a_buffer_that_is[] = "Can only create a buffer that is contiguous in memory.";
static const char __pyx_k_Empty_shape_tuple_for_cython_arr[] = "Empty shape tuple for cython.array";
static const char __pyx_k_Feature_and_class_labels_must_ha[] = "Feature and class labels must have identical lengths";
...
static PyObject *__pyx_kp_s_Feature_and_class_labels_must_ha;
...
static PyObject *__pyx_kp_s_This_function_only_works_on_two;
...
static PyObject *__pyx_pf_14hellinger_tree_calcHellingerDistance(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_features, __Pyx_memviewslice __pyx_v_class_labels); /* proto */
static PyObject *__pyx_pf_14hellinger_tree_2get_best_feature(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_featureMatrix, __Pyx_memviewslice __pyx_v_class_labels); /* proto */
...
static PyObject *__pyx_pw_14hellinger_tree_1calcHellingerDistance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_14hellinger_tree_calcHellingerDistance(__Pyx_memviewslice __pyx_v_features, __Pyx_memviewslice __pyx_v_class_labels, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n_features;
  int __pyx_v_i;
  int __pyx_v_n_samples;
  double __pyx_v_H;
  __pyx_t_5numpy_float64_t __pyx_v_total_pos;
  __pyx_t_5numpy_float64_t __pyx_v_total_neg;
  __Pyx_memviewslice __pyx_v_p_pos = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_p_neg = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_p;
  double __pyx_v_q;
  double __pyx_r;
  ...
  double __pyx_t_23;
  __Pyx_RefNannySetupContext("calcHellingerDistance", 0);

  /* "hellinger_tree.pyx":10
 * #Seems to work, maybe shld test some more
 * cpdef double calcHellingerDistance(np.int64_t [:] features, np.int64_t [:] class_labels):
 *     if features.shape[0] != class_labels.shape[0]:             # <<<<<<<<<<<<<<
 *         raise ValueError("Feature and class labels must have identical lengths")
 *     cdef int n_features
 */
  __pyx_t_1 = (((__pyx_v_features.shape[0]) != (__pyx_v_class_labels.shape[0])) != 0);
  if (__pyx_t_1) {

    /* "hellinger_tree.pyx":11
 * cpdef double calcHellingerDistance(np.int64_t [:] features, np.int64_t [:] class_labels):
 *     if features.shape[0] != class_labels.shape[0]:
 *         raise ValueError("Feature and class labels must have identical lengths")             # <<<<<<<<<<<<<<
 *     cdef int n_features
 ...
 * 
 */
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_features, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_int64_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_int64_t, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PySet_New(__pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = PySet_GET_SIZE(__pyx_t_3); if (unlikely(__pyx_t_4 == -1)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_n_features = __pyx_t_4;

  /* "hellinger_tree.pyx":21
 * 
 *     n_features = len(set(features)) #number of discrete features
 *     n_samples = features.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_n_samples = (__pyx_v_features.shape[0]);

  /* "hellinger_tree.pyx":24
 * 
 *     #assume the features are labelled as 0,1,2...
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_n_features); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(__pyx_t_7);
  if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v_p_pos = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "hellinger_tree.pyx":25
 *     #assume the features are labelled as 0,1,2...
 *     cdef np.float64_t[:] p_pos = np.zeros(n_features, dtype=np.float64)
 *     cdef np.float64_t[:] p_neg = np.zeros(n_features, dtype=np.float64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_zeros); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_n_features); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  ...
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_5, __pyx_t_7); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  ...
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_v_p_neg = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "hellinger_tree.pyx":27
 *     cdef np.float64_t[:] p_neg = np.zeros(n_features, dtype=np.float64)
 * 
 *     for i in xrange(n_samples):             # <<<<<<<<<<<<<<
 *         if class_labels[i] == 0:
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_class_labels.shape[0];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_class_labels.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 28, __pyx_L1_error)
    }
    __pyx_t_1 = (((*((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_class_labels.data + __pyx_t_11 * __pyx_v_class_labels.strides[0]) ))) == 0) != 0);
    if (__pyx_t_1) {

      /* "hellinger_tree.pyx":29
 *     for i in xrange(n_samples):
 *         if class_labels[i] == 0:
 *             p_neg[features[i]] += 1             # <<<<<<<<<<<<<<
 *             total_neg += 1
 ...
 */
      ...
      __pyx_t_12 = -1;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_features.shape[0];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_features.shape[0])) __pyx_t_12 = 0;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 29, __pyx_L1_error)
      }
      __pyx_t_14 = (*((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_features.data + __pyx_t_13 * __pyx_v_features.strides[0]) )));
      __pyx_t_12 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_p_neg.shape[0];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_p_neg.shape[0])) __pyx_t_12 = 0;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 29, __pyx_L1_error)
      }
      *((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_p_neg.data + __pyx_t_14 * __pyx_v_p_neg.strides[0]) )) += 1.0;

      /* "hellinger_tree.pyx":30
 *         if class_labels[i] == 0:
 *             p_neg[features[i]] += 1
 *             total_neg += 1             # <<<<<<<<<<<<<<
 *         elif class_labels[i] == 1:
 *             p_pos[features[i]] += 1
 */
      __pyx_v_total_neg = (__pyx_v_total_neg + 1.0);
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_class_labels.shape[0];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_class_labels.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 31, __pyx_L1_error)
    }
    __pyx_t_1 = (((*((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_class_labels.data + __pyx_t_15 * __pyx_v_class_labels.strides[0]) ))) == 1) != 0);
    if (__pyx_t_1) {

      /* "hellinger_tree.pyx":32
 *             total_neg += 1
 *         elif class_labels[i] == 1:
 *             p_pos[features[i]] += 1             # <<<<<<<<<<<<<<
 *             total_pos += 1
 ...
 */
      ...
      __pyx_t_12 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_features.shape[0];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_features.shape[0])) __pyx_t_12 = 0;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 32, __pyx_L1_error)
      }
      __pyx_t_17 = (*((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_features.data + __pyx_t_16 * __pyx_v_features.strides[0]) )));
      __pyx_t_12 = -1;
      if (__pyx_t_17 < 0) {
        __pyx_t_17 += __pyx_v_p_pos.shape[0];
        if (unlikely(__pyx_t_17 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_17 >= __pyx_v_p_pos.shape[0])) __pyx_t_12 = 0;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 32, __pyx_L1_error)
      }
      *((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_p_pos.data + __pyx_t_17 * __pyx_v_p_pos.strides[0]) )) += 1.0;

      /* "hellinger_tree.pyx":33
 *         elif class_labels[i] == 1:
 *             p_pos[features[i]] += 1
 *             total_pos += 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_v_total_pos = (__pyx_v_total_pos + 1.0);
 ...
 */
    /*else*/ {
      __pyx_t_6 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_18 < 0) {
      __pyx_t_18 += __pyx_v_p_neg.shape[0];
      if (unlikely(__pyx_t_18 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_18 >= __pyx_v_p_neg.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 40, __pyx_L1_error)
    }
    __pyx_t_19 = (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_p_neg.data + __pyx_t_18 * __pyx_v_p_neg.strides[0]) )));
    if (unlikely(__pyx_v_total_neg == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 40, __pyx_L1_error)
    }
    __pyx_v_p = (__pyx_t_19 / __pyx_v_total_neg);

    /* "hellinger_tree.pyx":41
 *     for i in xrange(n_features):
 *         p = p_neg[i] / total_neg
 *         q = p_pos[i] / total_pos             # <<<<<<<<<<<<<<
 *         H += (np.sqrt(p) - np.sqrt(q) )**2
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_20 < 0) {
      __pyx_t_20 += __pyx_v_p_pos.shape[0];
      if (unlikely(__pyx_t_20 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_20 >= __pyx_v_p_pos.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    __pyx_t_19 = (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_p_pos.data + __pyx_t_20 * __pyx_v_p_pos.strides[0]) )));
    if (unlikely(__pyx_v_total_pos == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    __pyx_v_q = (__pyx_t_19 / __pyx_v_total_pos);

    /* "hellinger_tree.pyx":42
 *         p = p_neg[i] / total_neg
 *         q = p_pos[i] / total_pos
 *         H += (np.sqrt(p) - np.sqrt(q) )**2             # <<<<<<<<<<<<<<
 *     H = np.sqrt(H)
 ...
 */
    __pyx_t_6 = PyFloat_FromDouble(__pyx_v_H); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_5 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = PyFloat_FromDouble(__pyx_v_p); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_2 = NULL;
    ...
    if (!__pyx_t_2) {
      __pyx_t_7 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_GOTREF(__pyx_t_7);
    } else {
      ...
      __pyx_t_5 = 0;
      __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_21, NULL); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
    }
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_21 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_21);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_21, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
    __pyx_t_21 = PyFloat_FromDouble(__pyx_v_q); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_21);
    __pyx_t_2 = NULL;
    ...
    if (!__pyx_t_2) {
      __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_21); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
      __Pyx_GOTREF(__pyx_t_3);
    } else {
      __pyx_t_22 = PyTuple_New(1+1); if (unlikely(!__pyx_t_22)) __PYX_ERR(0, 42, __pyx_L1_error)
      ...
      __pyx_t_21 = 0;
      __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_22, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_22); __pyx_t_22 = 0;
    }
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = PyNumber_Subtract(__pyx_t_7, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Power(__pyx_t_5, __pyx_int_2, Py_None); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = PyNumber_InPlaceAdd(__pyx_t_6, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_23 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_23 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_v_H = __pyx_t_23;
  }

  /* "hellinger_tree.pyx":43
 *         q = p_pos[i] / total_pos
 *         H += (np.sqrt(p) - np.sqrt(q) )**2
 *     H = np.sqrt(H)             # <<<<<<<<<<<<<<
 *     H /= np.sqrt(2) #normalise H to the range (0,1)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_H); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = NULL;
  ...
  if (!__pyx_t_7) {
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else {
    __pyx_t_22 = PyTuple_New(1+1); if (unlikely(!__pyx_t_22)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_22);
    __Pyx_GIVEREF(__pyx_t_7); PyTuple_SET_ITEM(__pyx_t_22, 0, __pyx_t_7); __pyx_t_7 = NULL;
    __Pyx_GIVEREF(__pyx_t_3);
    PyTuple_SET_ITEM(__pyx_t_22, 0+1, __pyx_t_3);
    __pyx_t_3 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_22, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_22); __pyx_t_22 = 0;
  }
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 * 
 */
  __pyx_t_5 = PyFloat_FromDouble(__pyx_v_H); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_22 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_22)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_22);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_22, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_22); __pyx_t_22 = 0;
  __pyx_t_22 = __Pyx_PyNumber_InPlaceDivide(__pyx_t_5, __pyx_t_6); if (unlikely(!__pyx_t_22)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_22);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_23 = __pyx_PyFloat_AsDouble(__pyx_t_22); if (unlikely((__pyx_t_23 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_22); __pyx_t_22 = 0;
  __pyx_v_H = __pyx_t_23;

  /* "hellinger_tree.pyx":45
 *     H = np.sqrt(H)
 *     H /= np.sqrt(2) #normalise H to the range (0,1)
 *     return H             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("hellinger_tree.calcHellingerDistance", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_p_pos, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_p_neg, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_14hellinger_tree_1calcHellingerDistance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14hellinger_tree_1calcHellingerDistance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_features = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_class_labels = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calcHellingerDistance (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_features,&__pyx_n_s_class_labels,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_class_labels)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calcHellingerDistance", 1, 2, 2, 1); __PYX_ERR(0, 9, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calcHellingerDistance") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    ...
    __pyx_v_features = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_int64_t(values[0]); if (unlikely(!__pyx_v_features.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_class_labels = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_int64_t(values[1]); if (unlikely(!__pyx_v_class_labels.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calcHellingerDistance", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hellinger_tree.calcHellingerDistance", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14hellinger_tree_calcHellingerDistance(__pyx_self, __pyx_v_features, __pyx_v_class_labels);
...
static PyObject *__pyx_pf_14hellinger_tree_calcHellingerDistance(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_features, __Pyx_memviewslice __pyx_v_class_labels) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("calcHellingerDistance", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_features.memview)) { __Pyx_RaiseUnboundLocalError("features"); __PYX_ERR(0, 9, __pyx_L1_error) }
  if (unlikely(!__pyx_v_class_labels.memview)) { __Pyx_RaiseUnboundLocalError("class_labels"); __PYX_ERR(0, 9, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_14hellinger_tree_calcHellingerDistance(__pyx_v_features, __pyx_v_class_labels, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_class_labels, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "hellinger_tree.pyx":48
 * 
 * 
...
static PyObject *__pyx_pw_14hellinger_tree_3get_best_feature(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_f_14hellinger_tree_get_best_feature(__Pyx_memviewslice __pyx_v_featureMatrix, __Pyx_memviewslice __pyx_v_class_labels, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n_features;
  CYTHON_UNUSED int __pyx_v_best_feature;
  __pyx_t_5numpy_float64_t __pyx_v_best_distance;
  ...
  __Pyx_RefNannySetupContext("get_best_feature", 0);

  /* "hellinger_tree.pyx":50
 * cpdef int get_best_feature(np.int64_t [:,:] featureMatrix, np.int64_t [:] class_labels):
 * 
 *     if featureMatrix.shape[0] != class_labels.shape[0]:             # <<<<<<<<<<<<<<
 *         raise ValueError("Feature and class labels must have identical lengths")
 * 
 */
  __pyx_t_1 = (((__pyx_v_featureMatrix.shape[0]) != (__pyx_v_class_labels.shape[0])) != 0);
  if (__pyx_t_1) {

    /* "hellinger_tree.pyx":51
 * 
 *     if featureMatrix.shape[0] != class_labels.shape[0]:
 *         raise ValueError("Feature and class labels must have identical lengths")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_n_features = (__pyx_v_featureMatrix.shape[1]);

  /* "hellinger_tree.pyx":54
 * 
 *     cdef int n_features = featureMatrix.shape[1]
 *     cdef int best_feature = -1             # <<<<<<<<<<<<<<
 *     cdef np.float64_t best_distance = -1
 ...
 */
    __pyx_t_5.data = __pyx_v_featureMatrix.data;
    __pyx_t_5.memview = __pyx_v_featureMatrix.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_5, 0);
    __pyx_t_5.shape[0] = __pyx_v_featureMatrix.shape[0];
__pyx_t_5.strides[0] = __pyx_v_featureMatrix.strides[0];
    __pyx_t_5.suboffsets[0] = -1;

{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_featureMatrix.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_featureMatrix.strides[1];
...
__pyx_v_distance = __pyx_f_14hellinger_tree_calcHellingerDistance(__pyx_t_5, __pyx_v_class_labels, 0);
    __PYX_XDEC_MEMVIEW(&__pyx_t_5, 1);

    /* "hellinger_tree.pyx":60
 *     for i in xrange(n_features):
 *         distance = calcHellingerDistance(featureMatrix[:,i], class_labels)
 *         if distance > best_distance:             # <<<<<<<<<<<<<<
 *             best_distance = distance
 *             best_feature = i
 */
    __pyx_t_1 = ((__pyx_v_distance > __pyx_v_best_distance) != 0);
    if (__pyx_t_1) {

      /* "hellinger_tree.pyx":61
 *         distance = calcHellingerDistance(featureMatrix[:,i], class_labels)
 *         if distance > best_distance:
 *             best_distance = distance             # <<<<<<<<<<<<<<
 *             best_feature = i
 ...
 * 
 */
      __pyx_v_best_feature = __pyx_v_i;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __PYX_XDEC_MEMVIEW(&__pyx_t_5, 1);
  __Pyx_WriteUnraisable("hellinger_tree.get_best_feature", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_14hellinger_tree_3get_best_feature(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14hellinger_tree_3get_best_feature(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_featureMatrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_class_labels = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_best_feature (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_featureMatrix,&__pyx_n_s_class_labels,0};
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_featureMatrix)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_class_labels)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_best_feature", 1, 2, 2, 1); __PYX_ERR(0, 48, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_best_feature") < 0)) __PYX_ERR(0, 48, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_featureMatrix = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_int64_t(values[0]); if (unlikely(!__pyx_v_featureMatrix.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_class_labels = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_int64_t(values[1]); if (unlikely(!__pyx_v_class_labels.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_best_feature", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 48, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hellinger_tree.get_best_feature", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14hellinger_tree_2get_best_feature(__pyx_self, __pyx_v_featureMatrix, __pyx_v_class_labels);
...
static PyObject *__pyx_pf_14hellinger_tree_2get_best_feature(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_featureMatrix, __Pyx_memviewslice __pyx_v_class_labels) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("get_best_feature", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_featureMatrix.memview)) { __Pyx_RaiseUnboundLocalError("featureMatrix"); __PYX_ERR(0, 48, __pyx_L1_error) }
  if (unlikely(!__pyx_v_class_labels.memview)) { __Pyx_RaiseUnboundLocalError("class_labels"); __PYX_ERR(0, 48, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_14hellinger_tree_get_best_feature(__pyx_v_featureMatrix, __pyx_v_class_labels, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_featureMatrix, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_class_labels, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "hellinger_tree.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "hellinger_tree._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"calcHellingerDistance", (PyCFunction)__pyx_pw_14hellinger_tree_1calcHellingerDistance, METH_VARARGS|METH_KEYWORDS, 0},
  {"get_best_feature", (PyCFunction)__pyx_pw_14hellinger_tree_3get_best_feature, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Feature_and_class_labels_must_ha, __pyx_k_Feature_and_class_labels_must_ha, sizeof(__pyx_k_Feature_and_class_labels_must_ha), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_This_function_only_works_on_two, __pyx_k_This_function_only_works_on_two, sizeof(__pyx_k_This_function_only_works_on_two), 0, 0, 1, 0},
 ...
 *     cdef int i
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Feature_and_class_labels_must_ha); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 *     cdef double p
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_This_function_only_works_on_two); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 35, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_int_2); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 44, __pyx_L1_error)
 ...
 *     cdef int n_features = featureMatrix.shape[1]
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_s_Feature_and_class_labels_must_ha); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 51, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inithellinger_tree(void); /*proto*/
PyMODINIT_FUNC inithellinger_tree(void)
#else
PyMODINIT_FUNC PyInit_hellinger_tree(void); /*proto*/
PyMODINIT_FUNC PyInit_hellinger_tree(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_hellinger_tree(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("hellinger_tree", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_hellinger_tree) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "hellinger_tree")) {
      if (unlikely(PyDict_SetItemString(modules, "hellinger_tree", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init hellinger_tree", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init hellinger_tree");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3

"""
    ...
    **************************************************************************
    ...
    |                                                                        |
    |    9 - 8 Features from Lyon et al + Pulse Period from Thornton         |
    |                                                                        |
...
class PulsarFeatureLab:
    ...
    def main(self,argv=None):
        ...
        if(self.feature_type < 1 or self.feature_type > 9):
            ...
            print "9    -    Lyon features plus mean period (as feature 1)"

...
class PHCX(Utilities.Utilities):
    ...
    def computeType_9(self):
        #candidate period + Lyon features, to enable sorting processed candidates by period

        candidateParameters = self.fe.getCandidateParameters(self.rawdata,self.profileIndex)
        self.features.append(float(candidateParameters[0]))# Feature 12 from Thornton. Best period.

        self.computeType_6() #call Lyon features
